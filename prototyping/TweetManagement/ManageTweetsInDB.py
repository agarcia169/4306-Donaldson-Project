...
#CHECK IF JOEL WENT AND DID ALL OF THIS ALREADY
...
def return_tweet_lang(int):


def return_tweet_author(int):


def return_tweet_date(int):


def add_tweet_to_database(int):


def add_tweets_from_author(str|int,int):


def add_tweets_from_author_from_date_range(str|int,int,datetime,datetime):